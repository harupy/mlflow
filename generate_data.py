...
def long_barchart():
    ...
    plt.barh(range(100), range(100), align="center", alpha=0.5)
    plt.savefig("tall_bar_chart.png")
...
with TemporaryDirectory() as tmpdir:
    ...
    with mlflow.start_run():
        ...
        mlflow.log_artifact("tall_bar_chart.png", artifact_path="images")

        mlflow.log_text("\n".join(["a"] * 1000), "long.txt")
