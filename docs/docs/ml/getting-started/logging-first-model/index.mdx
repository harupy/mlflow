...
<NotebookDownloadButton href="https://raw.githubusercontent.com/mlflow/mlflow/master/docs/docs/ml/getting-started/logging-first-model/notebooks/logging-first-model.ipynb">📓 Download the Complete Notebook</NotebookDownloadButton>
