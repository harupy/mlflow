...
<figure className="center-div" style={{ width: 1024, maxWidth: "100%", textAlign: "center" }}>
  ![Viewing plots in the UI](/images/guides/introductory/hyperparameter-tuning-with-child-runs/plots-in-ui.gif)
...
<p>
  <NotebookDownloadButton href="https://raw.githubusercontent.com/mlflow/mlflow/master/docs/docs/ml/traditional-ml/tutorials/hyperparameter-tuning/notebooks/logging-plots-in-mlflow.ipynb">Download the notebook</NotebookDownloadButton>
</p>
