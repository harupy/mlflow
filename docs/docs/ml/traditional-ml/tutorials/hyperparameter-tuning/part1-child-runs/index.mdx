...
<figure className="center-div" style={{ width: 1024, maxWidth: "100%", textAlign: "center" }}>
  ![Hyperparameter tuning no child runs](/images/guides/introductory/hyperparameter-tuning-with-child-runs/no-child-first.gif)
...
<figure className="center-div" style={{ width: 1024, maxWidth: "100%", textAlign: "center" }}>
  ![Adding more runs](/images/guides/introductory/hyperparameter-tuning-with-child-runs/no-child-more.gif)
...
<figure className="center-div" style={{ width: 1024, maxWidth: "100%", textAlign: "center" }}>
  ![Using child runs](/images/guides/introductory/hyperparameter-tuning-with-child-runs/child-runs.gif)
...
<p>
  <NotebookDownloadButton href="https://raw.githubusercontent.com/mlflow/mlflow/master/docs/docs/ml/traditional-ml/tutorials/hyperparameter-tuning/notebooks/parent-child-runs.ipynb">Download the notebook</NotebookDownloadButton>
</p>
...
<figure className="center-div" style={{ width: 1024, maxWidth: "100%", textAlign: "center" }}>
  ![Challenge](/images/guides/introductory/hyperparameter-tuning-with-child-runs/parent-child-challenge.gif)
